<template>
  ...
  <div
      class="fixed mx-auto w-full h-16 max-w-[330px] md:max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
