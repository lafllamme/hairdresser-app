...
class get_Container_Private_TwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtension(new \Pentatrion\ViteBundle\Twig\EntryFilesTwigExtension(($container->services['vite.entrypoint_renderer'] ?? $container->load('getVite_EntrypointRendererService'))));
